...
- Added a new `setDefaultNoCacheHeaders` config setting that determines whether no cache headers should be sent by default if no other cache headers are sent.
