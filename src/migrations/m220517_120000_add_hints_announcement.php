...
class m220517_120000_add_hints_announcement extends Migration
{
    ...
    public function safeUp(): bool
    {
        Craft::$app->announcements->push(
            ...
            Translation::prep('blitz', 'The new Blitz Hints utility displays templating performance hints for eager-loading elements in your Twig templates. [Read the announcement]({url}) &raquo;', [
