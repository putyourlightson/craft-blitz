...
> [!NOTE] _Tests whether requests are cacheable and under what circumstances._
...
![Pass](https://raw.githubusercontent.com/putyourlightson/craft-generate-test-spec/main/icons/pass.svg) Request with `_includes` path is a cached include.  
![Pass](https://raw.githubusercontent.com/putyourlightson/craft-generate-test-spec/main/icons/pass.svg) Request with include action is a cached include.  
...
> [!NOTE] _Tests the storing of cached values using the cache storage drivers._
...
> [!NOTE] _Tests the saving of cached values, element cache records and element query records._
...
> [!NOTE] _Tests the tracking of changes to elements and the resulting element cache IDs and element query type records._
...
> [!NOTE] _Tests the site URI helper methods._
...
> [!NOTE] _Tests that Commerce variants are refreshed on order completion so that their stock is updated._
...
> [!NOTE] _Tests that Feed Me imports refresh the cache with batch mode enabled._
...
> [!NOTE] _Tests that cached pages are refreshed when SEOmatic meta containers are invalidated._
...
> [!NOTE] _Tests that cached web responses contain the correct headers and comments._
